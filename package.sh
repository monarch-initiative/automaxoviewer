...
# Static variables
SRC_DIR="."
APP_NAME="automaxoviewer"
CMD_NAME="automaxoviewer"
VERSION=1.0.0

BUILD_DIR=${SRC_DIR}/target
#JAR_NAME="automaxoviewer-${VERSION}.jar"
JAR_NAME="automaxoviewer.jar"
VENDOR="Monarch Initiative"
DESCRIPTION="automaxoviewer is a Java application for curating the results of automaxo."
...
# The following function not used since automaxoviewer is not yet modular
function build_for_module_path() {
    ...
    if [[ "$PLATFORM" == "Linux" ]]; then
      ...
      MODULE="org.monarchinitiative.automaxoviewer/org.monarchinitiative.automaxoviewer.Launcher"
      printf "Module %s\n" "${MODULE}"
